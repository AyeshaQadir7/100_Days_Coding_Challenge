...
let myFvaoriteNumber = 7; //this saves your favorite number
console.log(`My favorite number is ${myFvaoriteNumber}. `); //this shows the messeage with your favorite number
export {};
